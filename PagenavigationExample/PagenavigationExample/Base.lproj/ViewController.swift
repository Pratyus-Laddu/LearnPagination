...
//  MovieDetails
//
//  Created by Pratyus Priyadarsi on 21/10/16.
...
class ViewController: UIViewController,UIPageViewControllerDataSource,UIScrollViewDelegate {
    ...
    @IBAction func unwindToMealList(_ sender: UIStoryboardSegue){
        if let sourceViewController = sender.source as? MovieDetails.BadgeViewController, let index = sourceViewController.index{
